...
<body>
    ...
    <div class="container">
        <form action="" method="POST" class="login-email">
            ...
            <div class="input-group">
                <button name="submit" class="btn btn_primary">Login</button>
            </div>
            <p class="login-register-text">Belum punya akun? Silahkan <a style="color: blue;" href="register.php">Register</a></p>
        </form>
    </div>
</body>
